...
-v ~/Documents/git/github/vending/django/Dockerfile/mysql/remote/docker-entrypoint-initdb.d:/docker-entrypoint-initdb.d \
--name mysql-omd-remote -e MYSQL_ROOT_PASSWORD=pjsong --restart unless-stopped -h mysql mysql
