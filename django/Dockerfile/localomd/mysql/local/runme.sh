...
sudo docker run -d \
-v ~/Documents/git/github/vending/django/Dockerfile/localomd/mysql/conf.d:/etc/mysql/conf.d \
-v ~/Documents/git/github/vending/django/Dockerfile/localomd/mysql/local/docker-entrypoint-initdb.d:/docker-entrypoint-initdb.d \
