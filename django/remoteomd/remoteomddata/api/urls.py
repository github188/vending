...
from remoteomddata.api.views.coinmachine import CoinChangeListAPIView, CoinChangeCreateAPIView, CoinChangeDetailAPIView, \
    CoinChangeUpdateAPIView, CoinChangeDeleteAPIView
from remoteomddata.api.views.config import ConfigListAPIView, ConfigCreateAPIView, ConfigDetailAPIView, \
    ConfigUpdateAPIView, ConfigDeleteAPIView
from remoteomddata.api.views.group import GroupListAPIView, GroupCreateAPIView, GroupDetailAPIView, GroupUpdateAPIView, \
    GroupDeleteAPIView
from remoteomddata.api.views.member import MemberListAPIView, MemberCreateAPIView, MemberDetailAPIView, \
    MemberUpdateAPIView, MemberDeleteAPIView
from remoteomddata.api.views.moneycharge import MoneyChargeListAPIView, MoneyChargeCreateAPIView, \
    MoneyChargeDetailAPIView, MoneyChargeUpdateAPIView, MoneyChargeDeleteAPIView
from remoteomddata.api.views.ordermain import OrderMainDeleteAPIView, OrderMainUpdateAPIView, OrderMainDetailAPIView, \
    OrderMainCreateAPIView, OrderMainListAPIView
from remoteomddata.api.views.permission.permissionview import adminPermView
from remoteomddata.api.views.product import ProductListAPIView, ProductCreateAPIView, ProductDetailAPIView, \
    ProductUpdateAPIView, ProductDeleteAPIView
from remoteomddata.api.views.productcategory import ProductCategoryListAPIView, ProductCategoryCreateAPIView, \
    ProductCategoryDetailAPIView, ProductCategoryUpdateAPIView, ProductCategoryDeleteAPIView
from remoteomddata.api.views.productprovider import ProductProviderListAPIView, ProductProviderCreateAPIView, \
    ProductProviderDetailAPIView, ProductProviderUpdateAPIView, ProductProviderDeleteAPIView
from remoteomddata.api.views.slot import SlotListAPIView, SlotCreateAPIView, SlotDetailAPIView, SlotUpdateAPIView, \
    SlotDeleteAPIView
from remoteomddata.api.views.slotstatus import SlotStatusListAPIView, SlotStatusCreateAPIView, SlotStatusDetailAPIView, \
    SlotStatusUpdateAPIView, SlotStatusDeleteAPIView
from remoteomddata.api.views.user import UserListAPIView, UserCreateAPIView, UserDetailAPIView, UserUpdateAPIView, \
    UserDeleteAPIView
from remoteomddata.api.views.vendingmachine import VendingMachineListAPIView, VendingMachineCreateAPIView, \
    VendingMachineDetailAPIView, VendingMachineUpdateAPIView, VendingMachineDeleteAPIView
from remoteomddata.api.views.vendingmachinetype import VendingMachineTypeListAPIView, VendingMachineTypeCreateAPIView, \
